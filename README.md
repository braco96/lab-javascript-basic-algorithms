...
- He completado todas las iteraciones básicas (names, conditionals, loops).
- He comentado el código en primera persona explicando decisiones y pasos.
- He añadido las soluciones de Bonus (conteo de palabras y detección de palíndromos) con un enfoque claro y didáctico.
- He probado el código en el navegador con DevTools para verificar la salida.
...
<details>
  ...
  - Manipulate strings using basic string methods (`toUpperCase()`, `toLowerCase()`, etc.).
